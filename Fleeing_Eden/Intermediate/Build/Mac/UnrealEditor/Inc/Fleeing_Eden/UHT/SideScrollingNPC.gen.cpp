...
#include "Fleeing_Eden/Variant_SideScrolling/AI/SideScrollingNPC.h"
...
FLEEING_EDEN_API UClass* Z_Construct_UClass_ASideScrollingNPC();
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ASideScrollingNPC_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_USideScrollingInteractable_NoRegister, (int32)VTABLE_OFFSET(ASideScrollingNPC, ISideScrollingInteractable), false },  // 239775988
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_kim_Documents_GitHub_kht9544_Fleeing_Eden_Fleeing_Eden_Source_Fleeing_Eden_Variant_SideScrolling_AI_SideScrollingNPC_h__Script_Fleeing_Eden_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ASideScrollingNPC, ASideScrollingNPC::StaticClass, TEXT("ASideScrollingNPC"), &Z_Registration_Info_UClass_ASideScrollingNPC, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASideScrollingNPC), 250330218U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_kim_Documents_GitHub_kht9544_Fleeing_Eden_Fleeing_Eden_Source_Fleeing_Eden_Variant_SideScrolling_AI_SideScrollingNPC_h__Script_Fleeing_Eden_3006386423(TEXT("/Script/Fleeing_Eden"),
	Z_CompiledInDeferFile_FID_kim_Documents_GitHub_kht9544_Fleeing_Eden_Fleeing_Eden_Source_Fleeing_Eden_Variant_SideScrolling_AI_SideScrollingNPC_h__Script_Fleeing_Eden_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_kim_Documents_GitHub_kht9544_Fleeing_Eden_Fleeing_Eden_Source_Fleeing_Eden_Variant_SideScrolling_AI_SideScrollingNPC_h__Script_Fleeing_Eden_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
